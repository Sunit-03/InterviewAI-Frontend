...
const Drawer = ({isOpen, onClose, title, children}) => {
  ...
  >
    <div className='flex items-center justify-between mb-4'>
        ...
        <button type='button' onClick={onClose} className='text-gray-400 bg-transparent hover:text-gray-900 rounded-xl text-sm w-8 h-8 inline-flex items-center justify-center'>
