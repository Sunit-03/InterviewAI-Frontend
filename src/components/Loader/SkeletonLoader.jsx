    ...
    <>
        ...
        <div role='status' className = 'animate-pulse space-y-4 max-w-3xl mt-10'>
            ...
            <div className='space-y-2'>
                ...
                <div className='h-4 bg-gray-200 rounded-md dark:bg-gray-700 w-11/12'></div>
                <div className='h-4 bg-gray-200 rounded-md dark:bg-gray-700 w-10/12'></div>
                <div className='h-4 bg-gray-200 rounded-md dark:bg-gray-700 w-9/12'></div>
            </div>
